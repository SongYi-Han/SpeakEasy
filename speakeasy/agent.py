...
graph, lbl2ent, ent2lbl, lbl2rel, entity_emb, relation_emb, ent2id, id2ent = load_kg.load()
            ...
            for room in current_rooms:
                ...
                if room['remainingTime'] > 0:
                    ...
                    if not self.chat_state[room_id]['initiated']:
                        ...
                        self.post_message(room_id=room_id, session_token=self.session_token, message="Hi, it's been a busy morning :)) How can I help you?")
                    ...
                    for message in all_messages:
                        if message['authorAlias'] != self.chat_state[room_id]['my_alias']:
                            ...
                            if message['ordinal'] not in self.chat_state[room_id]['messages']:
                                ...
                                answer = qna.answer(message['message'], graph, lbl2ent, ent2lbl, lbl2rel, entity_emb, relation_emb, ent2id, id2ent)
...
if __name__ == '__main__':
    username = 'songyi.han_bot'
    password = 'eD2s-Lqu7zcv2A'
